    ...
    return (
        <div className="flex flex-col items-center justify-center xl:h-[500px]">
            <div className="gap-6 flex-col justify-center text-center items-center">
                <OctagonXIcon/>
                {/* <img src={OctagonXIcon} alt="Error" className="xl:w-[132px] mx-auto" /> */}
            ...
            <Link className="btn btn-form-secondary btn-color-primary text-xs mt-[46px]" to="/" >Back to Home</Link>
        </div>
    )
}